...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Drone réel
        Node(package='tello_driver', executable='tello_driver_main', output='screen', namespace=ns+"33", parameters=[{"drone_ip": "192.168.50.33"}]),
        Node(package='tello_driver', executable='tello_driver_main', output='screen', namespace=ns+"103", parameters=[{"drone_ip": "192.168.50.103"}]),
        ...
        Node(package='tello_battery', executable='drone_sync_node', output='screen',
             namespace=ns),
