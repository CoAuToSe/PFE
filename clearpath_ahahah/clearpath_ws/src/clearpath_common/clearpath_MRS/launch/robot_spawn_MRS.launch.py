...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('robot_config_path',
                          default_value=[EnvironmentVariable('HOME'), '/clearpath/robot.yaml'],
                          description='Full path to robot.yaml configuration file'),
]
...
def launch_setup(context, *args, **kwargs):
    ...
    clearpath_config = ClearpathConfig(str(robot_config_path.perform(context)))
