    ...
    return LaunchDescription([
     ...
     #         arguments=[urdf_path, '0', '0', '1', '0']),
        ...
        Node(package='robot_state_publisher', executable='robot_state_publisher', output='screen',
             arguments=[urdf_path], namespace = "tello_1"), # namespace good

        # Joystick driver, generates /namespace/joy messages
        Node(package='joy', executable='joy_node', output='screen'), # no namespace 

        # Joystick controller, generates /namespace/cmd_vel messages
        Node(package='tello_driver', executable='tello_joy_main', output='screen'), # no namespace 

        Node(package='tello_driver', executable='tello_driver_main', output='screen', # no namespace 
              parameters=[{
        ...
        Node(package='tello_position', executable='tello_position_cal', output='screen', namespace = "tello_1"), #rajouté # namespace good

        Node(package='drone_energy_estimation', executable='battery_state', name='battery_state',
             output='screen', parameters=[drone_config, { "namespace": "tello_1"}], namespace = "tello_1"), # namespace good

        # Spawn tello_1.urdf
        Node(package='gazebo_ros', executable='spawn_entity.py', output='screen',
             arguments=['-file', urdf_path, '-entity', 'tello_drone'], namespace = "tello_1"), # namespace good
    ])
